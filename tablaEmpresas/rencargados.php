                  ...
                  <div class="container">
                      <div class="row">
                          <div class="col-lg-9 col-md-8">
                            <h1 class="font-weight-bold mb-0">Registro encargado de mantención</h1>
                          </div>
                ...
                <div class="contenedor">            
                        <div class="row">
                                <form action="/proyectoiso10/proyectoiso10/crud/insertarE.php" method="POST" class="formulario">
                                    ...
                                    <input type="text" class="form-control mb-3" name="apellido_e" placeholder="Apellido">
                                    <input type="text" class="form-control mb-3" name="cargo" placeholder="Cargo">
                                    <input type="text" class="form-control mb-3" name="password_enc" placeholder="Contraseña">
